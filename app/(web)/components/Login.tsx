							...
							<form action={doLogin}
							      className="mt-4 relative">
									...
									<div className="w-full flex items-center justify-center mt-8">
											<span className="text-sm text-white/70">Don&#39;t have an account? <span className="underline text-white font-medium">Sign up</span></span>
									</div>
							</form>
					</div>
			</div>
